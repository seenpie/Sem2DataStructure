...
Возьмите **чистую логику** из вашего метода (например, `Solve()`) и вставьте её в шаблон ниже:
...
- [ ] Все строки с подсказками пользователю (`Console.Write("Введите...")`, `Console.WriteLine("Результат:")` и т.п.) **полностью удалены**.
