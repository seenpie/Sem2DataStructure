...
| # | Название | Решений | Описание |
|---|----------|---------|----------|
| 02 | N-буквенные слова | 2 | Все N-буквенные слова из M букв алфавита (рекурсивно и итеративно) |
| 03 | Лучший преподаватель | 1 | Усечённое среднее по строкам 2D-массива |
| 04 | Комбинированный массив | 1 | Фильтр неубывающей подпоследовательности за один проход |
| 05 | Перестановка отрицательных | 1 | Partition in-place: отрицательные перед неотрицательными |
| 06 | Поиск в 2D-массиве | 1 | Бинарный поиск в 2D-массиве, отсортированном построчно |
| 07 | Калейдоскоп | 1 | Симметричный цветной узор в консоли |
